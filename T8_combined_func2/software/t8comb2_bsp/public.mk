...
JDI_FILE := H:/DSD/T8_combined_func2/hello_world.jdi

# Qsys--generated SOPCINFO file. Required for resolving node instance ID's with 
# design component names. 
SOPCINFO_FILE := H:/DSD/T8_combined_func2/nios2_cordic.sopcinfo
...
# Design Name 
# setting SOPC_NAME is nios2_cordic
SOPC_NAME := nios2_cordic
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x1001020
SOPC_SYSID_FLAG += --sidp=0x1001020
ELF_PATCH_FLAG  += --sidp 0x1001020

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1457789265
SOPC_SYSID_FLAG += --timestamp=1457789265
ELF_PATCH_FLAG  += --timestamp 1457789265
