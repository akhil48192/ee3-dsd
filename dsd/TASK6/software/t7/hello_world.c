...
#define ALT_CI_DSD_FP_ADD_CORDIC_0(A,B) __builtin_custom_fnff(ALT_CI_DSD_FP_ADD_CORDIC_0_N,(A),(B))
#define ALT_CI_DSD_FP_MULT_CORDIC_0(A,B) __builtin_custom_fnff(ALT_CI_DSD_FP_MULT_CORDIC_0_N,(A),(B))
