...
#define ALT_CI_DSD_FP_ALT_ADD_0(A,B) __builtin_custom_fnff(ALT_CI_DSD_FP_ALT_ADD_0_N,(A),(B))
#define ALT_CI_DSD_FP_ALT_MULT_0(A,B) __builtin_custom_fnff(ALT_CI_DSD_FP_ALT_MULT_0_N,(A),(B))
#define ALT_CI_DSD_FP_ALT_SUB_0(A,B) __builtin_custom_fnff(ALT_CI_DSD_FP_ALT_SUB_0_N,(A),(B))
...
float sumVector_cos_custom(float x[], unsigned int M)
{
	...
	int i=0;
	for (i=0; i<M; i++){
		result = ALT_CI_DSD_FP_ALT_ADD_0(result, (ALT_CI_DSD_FP_ALT_ADD_0(ALT_CI_DSD_FP_ALT_MULT_0(x[i], (const float)0.5), (ALT_CI_DSD_FP_ALT_MULT_0(ALT_CI_DSD_FP_ALT_MULT_0(x[i], x[i]), cosf(ALT_CI_DSD_FP_ALT_SUB_0(my_floor(ALT_CI_DSD_FP_ALT_MULT_0(x[i], (const float)0.25)), 32)))))));
		//result += ALT_CI_DSD_FP_ALT_MULT_0(x[i], (const float)0.5) + (ALT_CI_DSD_FP_ALT_MULT_0(ALT_CI_DSD_FP_ALT_MULT_0(x[i], x[i]), cosf(ALT_CI_DSD_FP_ALT_SUB_0(my_floor(ALT_CI_DSD_FP_ALT_MULT_0(x[i], (const float)0.25)), 32))));
		//result = ALT_CI_DSD_FP_ALT_ADD_0(result, (ALT_CI_DSD_FP_ALT_ADD_0((x[i]/2), (x[i]*x[i]*cosf(ALT_CI_DSD_FP_ALT_SUB_0(my_floor(ALT_CI_DSD_FP_ALT_MULT_0(x[i], (const float)0.25)), 32))))));
	}
	return result;
}
int main()
